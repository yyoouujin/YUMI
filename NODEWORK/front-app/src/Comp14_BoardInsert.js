...
*/
  ...
  <div>
    <Form.Control type="text" name="title" value={form.title} placeholder="제목" onChange={handlerChange} />
    <Form.Control type="text" name="content" value={form.content} placeholder="내용" onChange={handlerChange} />
    <Form.Control type="text" name="writer" value={form.writer} placeholder="작성자" onChange={handlerChange} />
    <Button type="button" className="btn-dark" onClick={handlerSave}>저장</Button>
  </div>
